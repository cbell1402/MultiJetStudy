...
run_num = file_list[0].split('/')[-2]
#run_num = 0
out_file = "MultiJet_histograms_" + run_num + ".root"

# p p > t t~, (t > w+ b, (w+ > j j)), (t~ > w- b~, (w- > j j))
myFile = ROOT.TFile.Open(out_file, "RECREATE")
...
#lhe_file = file_list[0]
#lhe_file = rd + lhe_file.replace('/eos/uscms/','')
#lhe_file = rd + lhe_file.replace('/eos/uscms/','')
print("Infile is:")
print(lhe_file)
print(" ")
